...
public class GruppoFactory {
    ...
    */
    ...
    private GruppoFactory(){
        ...
        UtenteFactory utentiregistratifactory = UtenteFactory.getInstanza();
    ...
    public List<Gruppo> getGruppoUtenteList(Utente utente){
        
        List<Gruppo> gruppiUtente = new ArrayList<>();
        
        for(Gruppo grp : this.ListaGruppi){
            if(grp.getMembro().equals(utente)){
                gruppiUtente.add(grp);
            } 
        }
        return gruppiUtente;
    }   
